```{r libraries, warning = FALSE, message = FALSE, echo = TRUE, include = FALSE}
...
Since we have 8378 observations, we used row percentages indtead of row count in our missing values plot. Below are the plots for missing values per question.
...
```{r}
missing_patterns_plot(df_1, percent = TRUE)
```

**For question 2_1:**

```{r}
missing_patterns_plot(df_2, percent = TRUE)
```

**For question 3_1:**

```{r}
missing_patterns_plot(df_3, percent = TRUE)
```

**For question 4_1:**

```{r}
missing_patterns_plot(df_4, percent = TRUE)
```

**For question 5_1:**

```{r}
missing_patterns_plot(df_5, percent = TRUE)
```
